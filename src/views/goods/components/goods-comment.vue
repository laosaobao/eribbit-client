<template>
  <div class="goods-comment">
    ...
    <div class="list">
     ...
     <!-- 分页 -->
    <XtxPagination @current-change="changePager" :total="total" :current-page="reqParams.page"  v-if="total>0"/>
  </div>
</template>
<script>
...
export default {
  ...
  setup(props) {
    ...
    return { commentInfo, currTagIndex, changeTag, reqParams, changeSort,commentList, formatSpecs, formatNickname, total, changePager }
  }
}
</script>
