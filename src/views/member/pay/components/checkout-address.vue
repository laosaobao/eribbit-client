...
<div class="checkout-address">
    ...
    <!-- 添加地址 -->
    <AddressEdit ref="addEdit" @on-success="successHandler" />
  </div>
</template>
<script>
import {ref} from 'vue'
...
export default {
  ...
  return {  showAddress, dialogVisible, selectedAddress, openDialog, confirmAddress,addEdit,
      openAddressEdit,successHandler }
 }
}
</script>
