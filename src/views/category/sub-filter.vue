<template>
  <div class="sub-filter" v-if="filterData && !filterLoading">
    ...
    <div class="item" v-for="item in filterData.saleProperties" :key="item.id">
      ...
      <div class="body">
        <a @click="changeAttr(item,Prop.id)" :class="{active:item.selectedProp===Prop.id}" href="javasript:;" v-for="Prop in item.properties" :key="Prop.id">{{Prop.name}}</a>
      </div>
    </div>
  </div>
